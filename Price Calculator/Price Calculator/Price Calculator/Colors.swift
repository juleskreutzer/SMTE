...
class Colors {
    /*                              OLD COLORS
    static var yellow : UIColor = UIColor(red: 1, green: 0.8, blue: 0.3, alpha: 1.0)
    static var green : UIColor = UIColor(red: 0, green: 0.7, blue: 0.6, alpha: 1.0)
    static var white : UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1.0)
